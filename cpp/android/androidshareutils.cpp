...
bool AndroidShareUtils::checkMimeTypeView(const QString &mimeType)
{
    ...
    jboolean verified = QAndroidJniObject::callStaticMethod<jboolean>("org/darakuta/payday/utils/QShareUtils",
                                              "checkMimeTypeView",
                                              "(Ljava/lang/String;)Z",
...
void AndroidShareUtils::share(const QString &text, const QUrl &url)
{
    ...
    jboolean ok = QAndroidJniObject::callStaticMethod<jboolean>("org/darakuta/payday/utils/QShareUtils",
                                              "share",
